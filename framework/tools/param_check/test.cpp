...
static void TestGetContext(const std::string &paraName)
{
#ifdef TIME_DISPLAY
    struct timeval start, end, diff;
    gettimeofday(&start, nullptr);
...
static void TestReadPara(const std::string &paraName)
{
#ifdef TIME_DISPLAY
    struct timeval start, end, diff;
    gettimeofday(&start, nullptr);
...
static void TestSetPara(const std::string &paraName, SrcInfo *info)
{
#ifdef TIME_DISPLAY
    struct timeval start, end, diff;
    gettimeofday(&start, nullptr);
